        ...
        try:
            ...
            stats_data = {
                ...
                "active_hospital": {
                    ...
                    "city": active_hospital_obj.city if active_hospital_obj else "Tirupur",
            ...
            return {
                "role_scope": role,
                "active_hospital": {"name": "St. Jude Memorial Hospital", "code": "SJH-01", "city": "Tirupur", "state": "MA"},
                "total_hospitals": 4,
                "total_departments": 5,
                "total_doctors": 1,
                "total_nurses": 1,
                ...
                "predictions_week": 3,
                "predictions_month": 3,
                "average_chd_risk_pct": 18.2,
                "high_risk_patients": 0,
                "very_high_risk_patients": 0,
                "risk_distribution_data": [
                    {"name": "Very Low (<5%)", "value": 1, "color": "#10b981"},
                    {"name": "Low (5-9.9%)", "value": 1, "color": "#059669"},
                    {"name": "Moderate (10-19.9%)", "value": 1, "color": "#f59e0b"},
                    {"name": "High (20-39.9%)", "value": 0, "color": "#ef4444"},
                    {"name": "Very High (>=40%)", "value": 0, "color": "#dc2626"},
                ],
                "prediction_trend_data": [],
                "hospital_comparison_data": [],
                "activity_feed": [],
