        ...
        try:
            with engine.connect().execution_options(isolation_level="AUTOCOMMIT") as conn:
                def safe_execute(statement_str):
                    try:
                        conn.execute(text(statement_str))
                    except Exception:
                        pass
                ...
                safe_execute("ALTER TABLE patients ADD COLUMN hospital_id UUID;")
                ...
                safe_execute("ALTER TABLE patients ADD COLUMN patient_uuid VARCHAR(64);")
                safe_execute("ALTER TABLE patients ADD COLUMN name VARCHAR(100);")
                safe_execute("ALTER TABLE patients ADD COLUMN gender INTEGER;")
                safe_execute("ALTER TABLE patients ADD COLUMN anchor_age INTEGER;")
                ...
                safe_execute("ALTER TABLE patients ADD COLUMN created_by UUID;")
                safe_execute("ALTER TABLE patients ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
                safe_execute("ALTER TABLE patients ADD COLUMN updated_by UUID;")
                ...
                safe_execute("ALTER TABLE admissions ADD COLUMN aspirin_history INTEGER DEFAULT 0;")
                safe_execute("ALTER TABLE admissions ADD COLUMN medication_count INTEGER DEFAULT 0;")
                ...
                safe_execute("ALTER TABLE admissions ADD COLUMN created_by UUID;")
                safe_execute("ALTER TABLE admissions ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
                safe_execute("ALTER TABLE admissions ADD COLUMN updated_by UUID;")
                ...
                safe_execute("ALTER TABLE diagnoses ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
                safe_execute("ALTER TABLE diagnoses ADD COLUMN created_by UUID;")
                safe_execute("ALTER TABLE diagnoses ADD COLUMN updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
                safe_execute("ALTER TABLE diagnoses ADD COLUMN updated_by UUID;")
                ...
                safe_execute("ALTER TABLE lab_results ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
                safe_execute("ALTER TABLE lab_results ADD COLUMN created_by UUID;")
                ...
                safe_execute("ALTER TABLE doctor_profiles ADD COLUMN is_deleted BOOLEAN DEFAULT FALSE;")
                safe_execute("ALTER TABLE doctor_profiles ADD COLUMN deleted_at TIMESTAMP;")
                safe_execute("ALTER TABLE doctor_profiles ADD COLUMN deleted_by UUID;")
                safe_execute("ALTER TABLE doctor_profiles ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;")
